  ...
  categories: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: "43. LA Galbi (엘에이 갈비)",
          price: "$25.99",
          shortdes:
            "Classic sweet and savory bone-in beef short ribs marinated in Korean soy sauce",
        },
        {
          name: "44. Beef Bulgogi (소 불고기)",
          price: "$21.99",
          shortdes:
            "Classic sliced beef marinated in special bulgogi sauce and onions",
        },
        {
          name: "45. Spicy Pork Bulgogi (돼지 불고기)",
          price: "$19.99",
          shortdes:
            "Sliced boneless pork marinated in special spicy bulgogi sauce grilled with onions",
        },
        {
          name: "46. Ttukbaegi Bulgogi (뚝배기 불고기)",
          price: "$17.99",
          shortdes:
            "Sliced beef marinated in special bulgogi sauce grilled with onions and rice cake",
        },
        {
          name: "47. Chicken Bulgogi (치킨 불고기)",
          price: "$19.99",
          shortdes:
            "Sliced chicken marinated in special bulgogi sauce grilled with onions",
        },
        {
          name: "48. Beef Brisket BBQ (차돌박이)",
          price: "$28.99",
          shortdes:
        ...
        {
          name: "50. Suyuk Pork Belly (수육 삼겹살)",
          price: "$26.99",
          shortdes:
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: "35. Naengmyeon / Bibim Naengmyeon (물냉면 / 비빔냉면)",
          price: "$14.99",
          shortdes:
            "Classic Korean cold noodles soup with your choice of regular or spicy",
        },
        {
          name: "36. Haemul Jeongol (해물 전골)",
          price: "$38.99",
          shortdes:
